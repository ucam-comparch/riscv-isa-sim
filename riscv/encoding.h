...
#define CSR_BAREMETAL_OUTPUT_HEX  0x800
#define CSR_BAREMETAL_OUTPUT_CHAR 0x801
#define CSR_BAREMETAL_OUTPUT_INT  0x802
...
#ifdef BARE_METAL_OUTPUT_CSR
DECLARE_CSR(bareMetalOutputHex, CSR_BAREMETAL_OUTPUT_HEX)
DECLARE_CSR(bareMetalOutputChar, CSR_BAREMETAL_OUTPUT_CHAR)
DECLARE_CSR(bareMetalOutputInt, CSR_BAREMETAL_OUTPUT_INT)
